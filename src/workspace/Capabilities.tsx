export function Capabilities() {
  return <section className="capabilities" aria-labelledby="capabilities-title">
    <div className="capabilities-heading"><h2 id="capabilities-title">A few files. Lots of possibilities.</h2><p>Start with your files. Make the document you need.</p></div>
